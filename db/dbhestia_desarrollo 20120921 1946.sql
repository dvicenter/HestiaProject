...
-- Script date 21/09/2012 19:46:38
...
CREATE DATABASE IF NOT EXISTS dbhestia_desarrollo
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_centro_atencion (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_cronograma_academica (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_facultad (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_justificacion (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_permiso (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_rol (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_tiempo (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_carrera_profesional (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_rol_permiso (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_persona (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_atencion (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_beneficiado (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_historial_persona (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_usuario (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_asistencia (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_usuario_permiso (
...
--
CREATE TABLE IF NOT EXISTS kz_hestia_usuario_rol (
...
--
INSERT INTO kz_hestia_centro_atencion(IdCentroAtencion, NombreCentroAtencion, NumeroPuntosAtencion) VALUES 
  (1, 'DON VITTOR', 3);

-- 
-- Dumping data for table kz_hestia_cronograma_academica
--
INSERT INTO kz_hestia_cronograma_academica(IdCronogramaAcademico, AnioAcademico, Semestre, FechaInicio, FechaCulminacion) VALUES 
  (1, 2012, 2, '2012-09-07', '2012-09-14');

-- 
-- Dumping data for table kz_hestia_facultad
--
INSERT INTO kz_hestia_facultad(IdFacultad, NombreFacultad) VALUES 
...
--
INSERT INTO kz_hestia_permiso(IdPermiso, ClavePermiso, NombrePermiso, FechaCreacion, FechaActualizacion) VALUES 
  (1, 'marcadoAsistencia', 'MarcadoAsistencia', '2012-09-05 22:12:25', NULL),
  (2, 'registroBeneficiado', 'RegistroBeneficiado', '2012-09-18 18:05:46', NULL);

-- 
-- Dumping data for table kz_hestia_rol
--
INSERT INTO kz_hestia_rol(IdRol, NombreRol, FechaCreacion, FechaActualizacion) VALUES 
  (1, 'admin', '2012-09-18 18:31:56', NULL);

-- 
-- Dumping data for table kz_hestia_tiempo
--
INSERT INTO kz_hestia_tiempo(IdTiempo, NumeroDia, NumeroMes, NumeroAnio, Fecha) VALUES 
  (1, 7, 9, 2012, '2012-09-07'),
  (2, 8, 9, 2012, '2012-09-08'),
  (3, 9, 9, 2012, '2012-09-09');

-- 
-- Dumping data for table kz_hestia_carrera_profesional
--
INSERT INTO kz_hestia_carrera_profesional(IdCarreraProfesional, IdFacultad, NombreCarreraProfesional) VALUES 
  (1, 1, 'Ingenieria Informatica');

-- 
-- Dumping data for table kz_hestia_rol_permiso
--
INSERT INTO kz_hestia_rol_permiso(IdRolPermiso, IdRol, IdPermiso, Valor, FechaCreacion) VALUES 
  (1, 1, 1, 1, '2012-09-18 18:32:32'),
  (2, 1, 2, 1, '2012-09-17 18:33:03');

-- 
-- Dumping data for table kz_hestia_persona
--
INSERT INTO kz_hestia_persona(IdPersona, IdTipoPersona, DNI, CodigoUniversitario, IdCarreraProfesional, NumCiclo, ApellidoPaterno, ApellidoMaterno, NombresCompleto, Sexo, FechaNacimiento, CiudadProcedencia, TelefonoFijo, Celular1, Celular2, CorreoElectronicoPersonal, CorreoElectronicoInstitucional, FechaCreacion, FechaActualizacion) VALUES 
...
--
INSERT INTO kz_hestia_atencion(IdAtencion, IdCentroAtencion, IdPersona, IdBeneficiado, IdTiempo, HoraAtencion) VALUES 
  (51, 1, 1, 1, 1, '2012-09-07 20:29:57'),
  (59, 1, 1, 1, 3, '2012-09-09 12:57:52');

-- 
-- Dumping data for table kz_hestia_beneficiado
--
INSERT INTO kz_hestia_beneficiado(IdBeneficiado, IdPersona, IdCronogramaAcademico, IdCarreraProfesional, IdFacultad, NumCiclo, DNI, Sexo, CodigoUniversitario, IdCondicionFinal, CondicionFinal, FechaCreacion, FechaActualizacion, NombresCompletos) VALUES 
...
--
INSERT INTO kz_hestia_usuario(IdUsuario, NombreUsuario, `Password`, IdPersona, IdCentroAtencion, FechaCreacion) VALUES 
...
--
-- Table dbhestia_desarrollo.kz_hestia_usuario_permiso does not contain any data (it is empty)

-- 
-- Dumping data for table kz_hestia_usuario_rol
--
INSERT INTO kz_hestia_usuario_rol(IdUsuarioRol, IdUsuario, IdRol, Valor, FechaCreacion) VALUES 
  (1, 1, 1, 127, '2012-09-18 18:32:13');

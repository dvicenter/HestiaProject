			...
			<legend>Registrar a Beneficiado</legend>
				...
				<div class="div_form_beneficiado">
					<div class="inline_div_form_beneficiado_3">
  						<label>Sexo</label>
  						<label class="radio inline"> 
					  	<input type="radio" name="rbt_sexo" value="M" checked="true">MASCULINO
						</label>
					 	<label class="radio inline"> 
					  		<input type="radio" name="rbt_sexo" value="F" checked="true">FEMENINO
						</label>
  					</div>
  					<div style="margin-left: 5px" class="inline_div_form_beneficiado_3">
  						<label>DNI</label>
  						<div class="block_div_form_beneficiado">
  							<span class="add-on"><i class="icon-user"></i></span><input class="span2" id="prependedInput" size="16" type="number" placeholder="DNI">
  						</div>
  					</div>  					
  					<div style="margin-left: 6%" class="inline_div_form_beneficiado_3">
  						<label>Código Universitario</label>
  						<div class="block_div_form_beneficiado">
  							<span class="add-on"><i class="icon-birrete"></i></span><input class="span2" id="prependedInput" size="16" type="number" placeholder="Codigo Universitario">
  						</div>
  					</div>
				</div>
				<div class="div_form_beneficiado">
					<div class="inline_div_form_beneficiado" style="width:60%">
						...
						<div class="cien_div_form_beneficiado">
							<span class="add-on"><i class="icon-birrete"></i></span><input data-provide="typeahead" class="span2" id="prependedInput" size="16" type="text" placeholder="Carrera Profesional">
						</div>
					</div>
					<div style="margin-left: 7%;width:30%" class="inline_div_form_beneficiado">
  						<label>Ciclo</label>
  						<div class="block_div_form_beneficiado">
  							<span class="add-on"><i class="icon-birrete"></i></span><input class="span2" id="prependedInput" size="16" type="text" placeholder="Apellido Paterno">
  						</div>
  					</div>
				</div>
		</fieldset>			  	
